  ...
  if (['ayuda', '/ayuda', 'help'].includes(text)) {
    return {
      ...
      reply: [
        ...
        '• compromiso <fecha/hora opcional> <texto> — tracking local, sin aviso automático',
        '• compromisos / compromisos vencidos',
        ...
        '',
        'Los compromisos se capturan explícitamente en tu self-chat; no se detectan automáticamente en chats externos ni envían recordatorios por sí solos.',
